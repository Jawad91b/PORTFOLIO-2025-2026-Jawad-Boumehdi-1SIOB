...
--
-- Hôte : localhost
-- Généré le : lun. 17 nov. 2025 à 15:59
...
--
-- Base de données : `paris-sportif-tp`
--
...
(1, 'PSG', 'OM', '2025-11-17 15:16:26', 1),
(2, 'Lakers', 'Bulls', '2025-11-17 15:16:26', 2),
(3, 'nadal', 'federer', '2025-11-17 15:16:26', 3);
...
ALTER TABLE `pari`
  ...
  ADD KEY `id_typepari_2` (`id_typepari`);
...
--
ALTER TABLE `pari`
  ADD CONSTRAINT `pari_ibfk_1` FOREIGN KEY (`id_typepari`) REFERENCES `typepari` (`id_typepari`),
  ADD CONSTRAINT `pari_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `utilisateurs` (`id_user`),
